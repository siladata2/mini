...
module.exports = {
    ...
    async execute({ sock, msg, args, jid }) {
            ...
            if (!stored || !stored.results || stored.results.length === 0) {
                ...
                return sock.sendMessage(jid, {
                    ...
                    contextInfo: {
                        ...
                        isForwarded: true,
                        forwardedNewsletterMessageInfo: {
                            newsletterJid: '120363425394543602@newsletter',                                                                                 newsletterName: '모🅒🅨🅑🅔🅡🅝🅞🅥🅐 🌟',
                            serverMessageId: 202,
                        },
                    },
                }, { quoted: msg });
        ...
        try {                                                               const { data } = await axios.get(
            ...
            activeSearches.set(senderJid, {                                     results: cleanedResults,
                timestamp: Date.now(),
            });
            ...
            await sock.sendMessage(jid, {
                text:
                    ...
                    '⚡ _Example: .spotify Blinding Lights_',                   contextInfo: {
                    forwardingScore: 350,
                    isForwarded: true,
                    forwardedNewsletterMessageInfo: {
                        newsletterJid: '120363425394543602@newsletter',
...
async function downloadSpotify(sock, msg, jid, trackUrl, title, artist) {
    try {
        ...
        const { data } = await axios.get(
            `https://api.giftedtech.co.ke/api/download/spotifydlv2?apikey=gifted&url=${encodedUrl}`,                                        { timeout: 90000 }
        );
        ...
        // Send as audio                                                await sock.sendMessage(jid, {
            audio: buffer,
            mimetype: 'audio/mpeg',
            ptt: false,
